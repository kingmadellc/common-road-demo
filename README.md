...
A 116-second illustrated film introduces the world, Jack's exhaustion, Ben finding Bea's smuggled radio, and three nights of family debate. A voice mentions an analog refuge in the Ozarks. Nobody has promised the Mercers a home.

The next chapter makes the decision urgent. Jack refuses an unsafe sign-off. His employer fires him; Work records a disputed charge, Cash holds joint wages, Food rejects payment and Home applies the staff-flat deadline. Sarah still has her job. She decides to load the van and ask Bea in person.

Travel from San Francisco through Richmond, Truckee, Wells, Rawlins, North Platte, Kansas and Ava to the Ozarks. Hunt, fish, trade, scavenge, repair the van and evade Safety's contracted Collectors. A rumor becomes a photograph, then an authenticated reply. Repair Glenn's pump or carry the Pruitts' filters to fulfill the eventual entry agreement.
...
This is a browser concept playtest. Automated browser and simulation checks are distinct from human playtesting or a physical Apple-device release. Film scenes use held illustrations and local light, weather and interface motion; no voiced or articulated character performances are claimed. Most illustration masters are 1672 × 941. SVG symbols scale independently.

## Studio

Created by King Made. The repository and public URL retain their original Common Road names to preserve existing links. Signals End is the selected game name.
