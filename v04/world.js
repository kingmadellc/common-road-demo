...
export const SAVE_KEY='common-road-pilgrimage-v4';
export const FAMILY=[
...
export const NODES=[
 {id:'yard',name:'Holt’s service yard',region:'WESTERN MISSOURI',art:'yard',x:.12,y:.1,desc:'The fan is failing. Bea Holt has a yard full of old machines. Somewhere in there is a second chance.',fish:false,salvage:true,shop:true},
...
export const ROADS=[
 {id:'opening',from:'approach',to:'yard',name:'Eighteen days from Everett',hours:0,fuel:0,wear:0,kind:'paved',text:'A failing cooling fan. A handwritten address.'},
 {id:'recovery',from:'ridge',to:'pump',name:'Back to Blackwater',hours:3,fuel:4,wear:3,kind:'paved',text:'Glenn keeps one repair route open if the delivery fails.'},
