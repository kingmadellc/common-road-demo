import {node} from './world.js?v=0.5.0';
import {drawRoad} from './motion.js?v=0.5.0';
import {drawSalvage,drawFishing} from './scenes.js?v=0.5.0';
import {filmPlayer,pauseFilms} from './video.js?v=0.5.0';
