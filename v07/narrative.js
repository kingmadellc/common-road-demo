...
export function knowledge(s){
 ...
 return {stage:'rumor',title:'Bea first',text:'Ben heard a place called Signals End on Bea’s smuggled radio. Jack wants to go. Sarah wants answers. After three nights of arguing, Core fires Jack and Index freezes their joint wallet. Their housing deadline comes before an appeal. They load the van and go to Bea. Nothing beyond that is confirmed.'};
}
export function migrateNarrative(s){
 ...
 if([2,3].includes(s.flags.narrativeRevision)){
