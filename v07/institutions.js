...
export const APPS=[
 {id:'watch',name:'ID',domain:'Identity & access',promise:'You, verified.',control:'One government record links your face, household, social credit standing and service access. Cameras check who is present; missing data can start a review. Its coverage has gaps.',presence:'Identity administration · Transbay',clue:'The same face check at a front door and a station gate.'},
 {id:'account',name:'Cash',domain:'Money & payments',promise:'Everything in one place.',control:'Wages, payments and deductions pass through a joint wallet. An adverse employer report through Work can lower household social credit below the access threshold and lock funds before a person reviews the report.',presence:'Payments administration · Financial District',clue:'The balance is still there. Available to spend: $0.00.'},
 ...
 {id:'food',name:'Food',domain:'Groceries & distribution',promise:'Your daily essentials.',control:'Stocked stores accept Cash payments authenticated through ID. A low social credit score locks the wallet and means no groceries. Independent traders outside the system still accept paper money, work and barter.',presence:'Distribution administration · South of Market',clue:'A full shelf beyond a checkout that cannot take your money.'},
 {id:'work',name:'Work',domain:'Jobs, assignments & wages',promise:'Your next assignment is ready.',control:'Private employers report jobs, hours and disputes here. Government rules turn adverse reports into social credit restrictions. Assigned restoration shifts and compliance review are the official way to earn access back. The supervisor has gone home; the consequences keep arriving.',presence:'Employment administration · South of Market',clue:'Employment ended. Other services have been notified.'},
 ...
 {id:'power',name:'Power',domain:'Utilities & machine permissions',promise:'Ready when you are.',control:'Utilities and licensed machinery require registered computer control modules and active permissions. Unconnected devices are prohibited; possession can trigger a credit review. A repairable pump can be disabled because its service contract expired.',presence:'Utilities administration · Potrero Point',clue:'An intact machine waiting for an account to say yes.'},
 ...
 {id:'enforcement',name:'Safety',domain:'Enforcement & recovery',promise:'For your protection.',control:'Automated credit restrictions and relocation orders are enforced by contracted Collector crews. Human contractors put people in vehicles; the order arrives through an app.',presence:'Recovery administration · Hunters Point',clue:'A clean shield on a truck taking a family back to compulsory work.'}
];
// Compatibility export for older tooling; these are now mandatory public apps.
export const CORPORATIONS=APPS;
export const WORLD_PREMISE='San Francisco, 2041. Nine mandatory apps control daily life. Private companies built the system and still collect its fees. The government made it compulsory, then handed more decisions to AI. Jobs, food, housing and money depend on one shared ID and social credit standing. Below the access threshold, your money cannot buy anything through the approved system. Work offers restoration shifts and compliance review. Restrictions spread in seconds. A human appeal takes days.';
