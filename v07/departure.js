import {drawService} from './service-marks.js?v=0.8.9-sequence-1';
import {fixedShot,sceneMotion} from './cinematic-motion.js?v=0.8.9-sequence-1';
...
export const DEPARTURE_SCENES=[
 {id:'refusal',seconds:7,image:'departure-workshop',focus:.5,motion:'screen',region:[.04,.22,.15,.22],kicker:'THE NEXT MORNING · CONTRACTOR WORKSHOP',speaker:'Jack',line:'“The cutoff’s broken. I’m not signing that.”'},
 ...
 {id:'decision',seconds:0,image:'cine-decision',focus:.51,motion:'dust',kicker:'BACK TO BEA. SHE GAVE BEN THE RADIO.',speaker:'Sarah',line:'“I don’t know if that place exists. I know we can’t stay here. Get the kids.”'},
...
export function finishDeparture(s){s.mode='packing';s.departure=null;s.flags.departureSeen=true;s.message='The basics are aboard. Choose what fits in the last six spaces. Back to Bea, who gave Ben the radio; then a plan.';}
