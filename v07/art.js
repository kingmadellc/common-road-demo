import {drawPrologue} from './prologue.js?v=0.7.3-world-2';
import {node} from './world.js?v=0.7.3-world-2';
import {drawRoad} from './motion.js?v=0.7.3-world-2';
import {drawSalvage,drawFishing} from './scenes.js?v=0.7.3-world-2';
import {filmPlayer,pauseFilms} from './video.js?v=0.7.3-world-2';
