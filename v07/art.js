import {drawPrologue} from './prologue.js?v=0.7.5-names-1';
import {node} from './world.js?v=0.7.5-names-1';
import {drawRoad} from './motion.js?v=0.7.5-names-1';
import {drawSalvage,drawFishing} from './scenes.js?v=0.7.5-names-1';
import {filmPlayer,pauseFilms} from './video.js?v=0.7.5-names-1';
