...
export const SHOTS={
 'sierra-letter':shot('open-country','The first witness','June shows Sarah a photograph: Uncle Frank beside a crooked fence. “He built that. No software could make it that bad.” For the first time, Signals End feels like a place.'),
 'nevada-room':shot('plaza','A room without permission','Ruth opens the motor court door with a brass key. One night of ordinary privacy. Sarah checks the lock twice, then lets herself sit down.'),
 'ben-wrench':shot('repair-family','Something that stays fixed','Ben gets the headlamp working. Jack asks him how. Not an answer from a screen: his answer. Beyond the shelter, the wind keeps trying to take the door off.'),
 'frank-letter':shot('market','It is really him','Frank’s reply has the family password Sarah asked for. Four people and Rusty. A house held until the convoy leaves. Glenn can witness the papers; the Pruitts can assign a filter delivery. The rumor is now an agreement.'),
 ...
 seized:shot('seized','They take the home, too','The camper is being towed back toward a company city. Its owners are in the transport behind it.'),
