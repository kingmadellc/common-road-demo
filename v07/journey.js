import {RADIO_MESSAGE} from './narrative.js?v=0.7.3-world-2';
...
export const SHOTS={
 ...
 collectors:shot('squad','Workforce recovery','Bastion Civic calls it household recovery. Debt and unauthorized relocation give its Collectors the paperwork. The people in the transport call it being dragged home.'),
 ...
 campus:shot('campus','Your future has been discontinued','Relay’s billboard promises “Your potential. Connected.” Beneath it, a Lattice camera counts faces. Sarah: “Lovely. The building still remembers us.”'),
 ...
 night:shot('night-family','The quiet between stops','Sarah wakes expecting the apartment’s morning compliance chime. Annie moves closer. Outside, somebody is fixing a generator by lamplight.'),
