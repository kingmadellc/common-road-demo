import {freshCapacity} from './hunting.js?v=0.8.0-hunt-1';
...
import {fresh,load,save,act,update,summary,slots,clamp} from './sim.js?v=0.8.0-hunt-1';
import {render,ready,HAZARDS,HOME_POINTS,sources} from './art.js?v=0.8.0-hunt-1';
