...
export function filmPlayer(id,elapsed,paused){
 ...
 let video=players.get(id);if(!video){video=document.createElement('video');video.muted=true;video.playsInline=true;video.preload='auto';video.src=`assets/journey-v05/film-${id}.mp4?cut=084`;video.setAttribute('aria-hidden','true');players.set(id,video);}
