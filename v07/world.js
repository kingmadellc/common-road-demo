...
export const FAMILY=[
 {id:'jack',name:'Jack',full:'Jack Mercer',role:'44 · former maintenance technician',line:'If it needs a password, hit it with something heavier.',story:'Jack used to repair machines. Continuum made him an orchestrator: watch the maintenance agents, catch their mistakes, take the blame. A camera scored his attention. Rent, groceries and taxes kept him accepting another shift. He repaired things off the books. Ben’s midnight broadcast gave those skills somewhere to go.',keepsake:'His dad’s socket wrench. The ratchet slips. He knows where.'},
 {id:'sarah',name:'Sarah',full:'Sarah Mercer',role:'42 · former care coordinator',line:'The fridge laid us off. Benefits were shit anyway.',story:'Sarah arranged care before software replaced her. Then she supervised its decisions for less money, with more people depending on her. Miss a queue; miss rent. When she catches Ben listening to the forbidden radio, she reaches to turn it off. Then she listens. She keeps a paper address book and remembers how to help without a dashboard.',keepsake:'A paper address book. Half the numbers are dead. She keeps them anyway.'},
