import {knowledge} from './narrative.js?v=0.8.0-hunt-1';
export const VERSION='0.7.0';
export const SAVE_KEY='signals-end-journey-v7';
export const FAMILY=[
 {id:'jack',name:'Jack',full:'Jack Mercer',role:'44 · former maintenance technician',line:"Sorry. Tell me again. I’m listening.",story:"Jack is good with machinery and increasingly absent everywhere else. Core’s work queues, automated warnings and endless confirmations follow him home. He checks them after his shift, then checks again. Sarah repeats a question; he cannot remember the first time. He has wanted out for months without knowing where out could be. Ben’s radio gives that wish a name. Jack is hopeful enough to push too hard. He has to listen to his family, too.",keepsake:'His dad’s socket wrench. The ratchet slips. He knows where.'},
 {id:'sarah',name:'Sarah',full:'Sarah Mercer',role:'42 · former care coordinator',line:"I want it to be real. That’s why I have questions.",story:"Sarah coordinates care through Vita’s eligibility screens, then comes home to bills and a husband whose attention is still at work. She is furious at what this life has cost them. Ben’s broadcast makes her wonder what they have been missing. It also sounds like the sort of promise desperate people get hurt believing. For three nights she and Jack argue, calculate and listen again. She writes the questions and chooses the first step: Bea’s yard. Curiosity is not a promise to keep going.",keepsake:'A paper address book. Half the numbers are dead. She keeps them anyway.'},
 {id:'ben',name:'Ben',full:'Ben Mercer',role:'15 · apprentice by necessity',line:"Wait. No school logins? No games either?",story:"Ben likes games, his friends and taking things apart. He tries the dial on the receiver Bea smuggled among repair parts because he wants to hear what it can find. The midnight voice catches him off guard. He writes down its message and brings Jack to listen the following night. Finding it feels enormous. Leaving his friends does not. He wants to know whether Signals End is real without having already decided what he will give up.",keepsake:'A dead handheld. It cannot cross the Line. He is not ready to say goodbye.'},
 {id:'annie',name:'Annie',full:'Annie Mercer',role:'10 · asks the difficult questions',line:"Are we going on a trip or moving?",story:"Annie wants Dad to look at her drawings before the next work alert takes him away. She is excited by the old van and worried about her room, her friends and who will feed the neighbor’s cat. Her parents cannot answer everything. On the road she sketches what they pass, gets bored, argues with Ben and sometimes forgets to be afraid. More than a perfect new home, she wants them to have time for her.",keepsake:'A tin of pencils, worn almost down to the paint.'},
...
export const NODES=[
 ...
 {id:'plains',name:'North Platte exchange',short:'North Platte',region:'NEBRASKA · THE PAPER NETWORK',chapter:5,art:'market',x:.63,y:.37,desc:'A courier brings Frank’s reply: “I have reserved a home for you. Get a witness or carry the filters. Evelyn has your names.” Sarah checks the family password in the margin. It is him. South into Kansas, the trail splits.',purpose:'Choose how to activate Frank’s household reservation: repair work or a filter delivery.',fish:true,salvage:true,shop:true},
...
export const ROADS=[
 {id:'opening',from:'approach',to:'yard',name:'San Francisco → East Bay',miles:25,hours:0,fuel:0,wear:0,kind:'paved',monitored:true,text:'Across the Bay Bridge to ask Bea what she knows. Sarah’s questions are on paper.'},
 ...
 {id:'plains-road',from:'divide',to:'plains',name:'Follow the Platte east',via:'I-80 · Cheyenne · North Platte',miles:355,hours:7,fuel:9,wear:6,kind:'paved',text:'Bea arranged a courier pickup at North Platte. Find out whether Sarah’s inquiry reached Frank.'},
...
export function objective(s){
 if(s.mode==='home'||s.ending?.owned)return 'Put the machines to bed. Spend the evening with your family.';
 if(s.mode==='ending')return s.ending.text;
 if(s.road)return 'Reach '+node(s.road.to).short+'. '+s.road.text;
 if(s.mode==='packing')return 'Pack six spaces. Ask Bea about Ben’s broadcast; fix the van at her yard.';
...
export function admission(s){return s.sponsor?'Reservation active · Glenn signed':s.cargo&&s.cargo.condition>=45?'Delivery aboard · protect the filters':s.cargo?'Filters damaged · find a replacement at the ridge':s.flags.reservationConfirmed?'Frank reserved a home · earn a witness or deliver filters':knowledge(s).text;}
export const PACKING=[
 ...
 {id:'battery',name:'Spare relay',slots:1,icon:'▰',text:'A repairable electromechanical relay. Useful for old engines and pumps.'},
 {id:'radio',name:'Shortwave receiver',slots:1,icon:'▣',text:'Bea’s smuggled receiver. Road warnings save detour fuel. Ben’s written clue stays with you either way.'}
];
