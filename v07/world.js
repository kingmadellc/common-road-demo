import {knowledge} from './narrative.js?v=0.7.3-world-2';
export const VERSION='0.7.0';
export const SAVE_KEY='signals-end-journey-v7';
export const FAMILY=[
 {id:'jack',name:'Jack',full:'Jack Mercer',role:'44 · former maintenance technician',line:'If it needs a password, hit it with something heavier.',story:'Jack repaired machines until Aster sealed them behind service contracts. Now he takes whatever company work pays, and fixes things off the books. Rent, groceries, taxes and equipment fees eat the difference. Ben’s midnight broadcast gives his old skills somewhere to go.',keepsake:'His dad’s socket wrench. The ratchet slips. He knows where.'},
 {id:'sarah',name:'Sarah',full:'Sarah Mercer',role:'42 · former care coordinator',line:'The fridge laid us off. Benefits were shit anyway.',story:'Sarah arranged care until Helix made eligibility more important than people. Helping someone the system rejected could cost her job and the family’s coverage. When she catches Ben listening to the forbidden radio, she reaches to turn it off. Then she listens. She keeps a paper address book and remembers who needed help.',keepsake:'A paper address book. Half the numbers are dead. She keeps them anyway.'},
 {id:'ben',name:'Ben',full:'Ben Mercer',role:'15 · apprentice by necessity',line:'So the old stuff works because it’s too stupid to refuse?',story:'At fifteen, Ben has never known a room without a screen watching back. One night he finds the receiver Bea smuggled among repair parts. He tunes past the static and hears Signals End. The voice does not know his name. He writes it down. Leaving still means losing friends behind his school login; learning a wrench does not make that painless.',keepsake:'A dead handheld. It cannot cross the Line. He is not ready to say goodbye.'},
 {id:'annie',name:'Annie',full:'Annie Mercer',role:'10 · asks the difficult questions',line:'If the house is smart, why are we sleeping in the van?',story:'Annie knows the workstation camera gets more of Dad’s attention than she does. She hates being told they are just tired. On the road she counts cameras until there are more trees. She draws what she sees, shares her blanket with Rusty, and waits for her parents to have time to look.',keepsake:'A tin of pencils, worn almost down to the paint.'},
