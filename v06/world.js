...
export const NODES=[
 ...
 {id:'line',name:'The Line',region:'MORROW BASIN',art:'gate',x:.5,y:.96,desc:'There it is. Warm lights across the reservoir. Evelyn Ward is checking the last households. Phones, computers and all digital devices must stay in the border storehouse. Even switched off. The storm will close intake soon.',fish:false,salvage:false,shop:false}
];
export const ROADS=[
