import {VERSION,SAVE_KEY,PACKING,PARTS,ROADS,node,random,siteItems} from './world.js?v=0.6.0-family-02';
import {startFishing,fishingAction,updateFishing} from './fishing.js?v=0.6.0-family-02';
import {startSalvage,salvageAction,updateSalvage,saveSite} from './salvage.js?v=0.6.0-family-02';
import {showStory,roadShots,updateReel} from './journey.js?v=0.6.0-family-02';
import {clamp,log,slots,consumeFresh,spend,finish,hurt,shopStock,OFFERS} from './state.js?v=0.6.0-family-02';
import {makeIncident,resolveIncident} from './conflict.js?v=0.6.0-family-02';
import {advanceRoad} from './drive.js?v=0.6.0-family-02';
...
export function act(s,a){
 ...
 case 'repairMethod':{const g=s.activity;if(s.mode!=='repair'||g.phase!=='method')throw Error('Fit the part first.');g.phase=a.id==='steady'?'steady':'tune';g.stable=0;g.elapsed=0;g.tuneCenter=.58+((s.seed+s.stats.repairs*3)%5)*.035;g.notice=a.id==='steady'?'Sarah holds the light. Ben watches the connections.':'Move the regulator into the brass band and hold it there.';spend(s,a.id==='steady'?(hurt(s)?2:1.5):.5);break;}
