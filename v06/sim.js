import {VERSION,SAVE_KEY,PACKING,PARTS,ROADS,node,random,siteItems} from './world.js?v=0.6.0';
import {startFishing,fishingAction,updateFishing} from './fishing.js?v=0.6.0';
import {startSalvage,salvageAction,updateSalvage,saveSite} from './salvage.js?v=0.6.0';
import {showStory,roadShots,updateReel} from './journey.js?v=0.6.0';
import {clamp,log,slots,consumeFresh,spend,finish,hurt,shopStock,OFFERS} from './state.js?v=0.6.0';
import {makeIncident,resolveIncident} from './conflict.js?v=0.6.0';
import {advanceRoad} from './drive.js?v=0.6.0';
